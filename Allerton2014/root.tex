...
\title{The capacity of non-identical \\
...
We use concentration of measure results to bound the probability that this algorithm requires many more tests than the expected number.
